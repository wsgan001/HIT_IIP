...
public class ROCmultiplot {
	...
	public XYSeriesCollection GetCollection() {
		...
		XYSeries mSeriesFirst = new XYSeries("单层感知机");
		
		for(int i = 0; i < 21; i++) {
			mSeriesFirst.add(data1[i][0], data1[i][1]);
		}
				
		XYSeries mSeriesSecond = new XYSeries("多层感知机");
